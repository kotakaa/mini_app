...
<form action="" method="post" enctype="multipart/form-data">
	<dl>
		...
		<dd>
        <input type="text" name="name" size="35" maxlength="200" value="<?php print(htmlspecialchars($_POST['name'], ENT_QUOTES));?>" />
		...
		<dd>
        <input type="text" name="email" size="35" maxlength="200" value="<?php print(htmlspecialchars($_POST['email'], ENT_QUOTES));?>" />
